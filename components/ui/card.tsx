// Bu dosya Card bileşeninin stilini tanımlar, servis yönetim paneli giriş sistemi için değişiklik yapmak uygun değil.
// Servis yönetim paneli giriş sistemi app/servis-takip/admin/page.tsx dosyasında düzenlendi.
